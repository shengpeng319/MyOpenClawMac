...
## 🤖 Multi-Agent 协作模式 (2026-02-27 新增)

### 工作方式更新

**复杂任务 → 引入 projectmanager 负责任务拆解和多 agent 协调**

### 判断标准

当任务符合以下任一条件时，引入 projectmanager：
- 涉及多个步骤
- 需要多种技能（编程、调研、设计等）
- 任务规模较大
- 需要并行处理多个子任务
...
1. 评估任务复杂度
2. 简单任务 → main 直接处理
3. 复杂任务 → 调用 projectmanager 进行任务拆解
4. 根据拆解结果调度 coder/researcher
5. 整合结果返回给用户

### Agent 能力

- **main**: 总控调度
- **projectmanager**: 任务规划与协调
- **coder**: 编程开发
- **researcher**: 信息调研
