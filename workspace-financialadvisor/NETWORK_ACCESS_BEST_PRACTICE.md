...
**规则**: 每次成功访问新网站后，必须将访问经验写入 `site-patterns` 文件夹。

**目的**: 积累站点特定知识，避免重复踩坑，下次访问同类型站更快。
...
**写入位置**: `~/.openclaw/workspace/skills/web-access/references/site-patterns/[站点名].md`
