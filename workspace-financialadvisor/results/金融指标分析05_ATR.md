...
# RSI 计算（标准 Wilder's 平滑法，与 Lesson 2 一致）
...
# 查看结果
print(hist[['Close', 'H-L', 'H-PC', 'L-PC', 'TR', 'ATR', 'RSI']].tail(10))
```
...
4. 但要注意：ATR 放大也可能是假突破

> 💡 **注：** 成交量验证是进阶技巧，将在后续课程中详细讲解。
...
| v1.2 | 2026-03-28 | Claire QA后：RSI改用标准Wilder公式；速查表2×ATR改为2.5×ATR；思考题3成交量说明后移 |
